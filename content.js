chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    ...
    if (message.action === "highlight") {
        ...
        if (!element) {
            ...
            console.error(
                "Accessibility element not found:",
                targets
            );
        ...
        const previousHighlight =
            document.querySelector(".a11y-highlight");

        if (previousHighlight) {

            previousHighlight.classList.remove(
                "a11y-highlight"
            );
        ...
        let styleElement =
            document.getElementById("a11y-highlight-style");
        ...
        console.log(
            "Accessibility element highlighted:",
            element
        );
